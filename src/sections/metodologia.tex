...
Esta seção descreve a metodologia adotada para o desenvolvimento do \textit{Tô De Olho}, detalhando a abordagem de desenvolvimento, as fontes de dados utilizadas, a arquitetura do sistema, a estratégia de ingestão, o algoritmo de ranking e a infraestrutura de implantação.
...
O sistema integra três fontes de dados governamentais oficiais, cada uma com características, formatos e \textit{endpoints} distintos. A seguir, detalhamos os recursos consumidos de cada API.
