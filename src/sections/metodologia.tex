...
A avaliação objetiva do desempenho parlamentar é elemento central para a participação cidadã. Conforme a escada de participação de Arnstein \cite{arnstein1969ladder}, o acesso a informações claras é pré-requisito para que cidadãos avancem de níveis consultivos para controle social efetivo. A construção de rankings requer transparência metodológica \cite{hullman2011visualization}.
