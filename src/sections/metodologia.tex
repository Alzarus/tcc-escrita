...
A renovação do Senado Federal em terços alternados --- 1/3 em uma eleição, 2/3 na seguinte --- implica que senadores ativos na 57ª legislatura possuem mandatos iniciados em anos distintos (2019 ou 2023). O índice proposto não normaliza automaticamente por tempo de mandato ativo, optando por oferecer filtros temporais (ano específico ou mandato completo desde 2023) que permitem ao usuário realizar comparações contextualizadas. Versões futuras poderão implementar normalização por meses de exercício efetivo.
