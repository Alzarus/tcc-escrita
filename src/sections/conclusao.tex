...
Para trabalhos futuros, almeja-se a implementação das funcionalidades mapeadas nos Requisitos mas não contempladas no MVP (Minimum Viable Product), a saber:
\begin{enumerate}
    \item \textbf{Módulo de Gabinete (RF17, RF18)}: Visualização da lista de servidores comissionados e folha de pagamento detalhada;
    \item \textbf{Módulo de Fornecedores Suplementar (RF06, RF07, RF20)}: Ranking de recebedores, alertas de despesas atípicas e cruzamento com sanções administrativas;
