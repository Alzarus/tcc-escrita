...
Uma limitação relevante deste trabalho é a ausência do módulo de fórum para debate cívico, inicialmente planejado mas não implementado devido a restrições de prazo. Conforme aponta Costa \cite{duarte2019}, a gestão pública digital efetiva requer não apenas transparência, mas também canais de participação direta. O \textit{Tô De Olho} avança significativamente na dimensão da prestação de contas, porém ainda não contempla espaços deliberativos.
