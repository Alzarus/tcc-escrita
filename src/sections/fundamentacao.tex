...
Este eixo apresenta os fundamentos técnicos e metodológicos que orientam a implementação do \textit{Tô De Olho}, incluindo métricas de avaliação parlamentar, princípios de visualização de dados e decisões arquiteturais.
...
\begin{enumerate}
    ...
    \item \textbf{Carga (Load)}: Persistência dos dados transformados no banco PostgreSQL, com estratégias de upsert para evitar duplicação e manutenção de histórico de alterações.
\end{enumerate}
