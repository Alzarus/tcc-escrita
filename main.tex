...
\begin{enumerate}
    \item \textbf{Ranking Metodologicamente Fundamentado}: inspirado no \textit{Legislative Effectiveness Score} de Volden e Wiseman \cite{volden2018legislative}, o algoritmo de avaliação pondera presença em votações (25\%), produtividade legislativa (25\%), economia na cota parlamentar (20\%), participação em comissões (15\%) e transparência de dados (15\%). Os critérios e pesos são públicos, permitindo ao cidadão compreender --- e questionar --- a metodologia;
