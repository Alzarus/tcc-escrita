...
O \textit{Tô De Olho} é uma plataforma \textit{web} de transparência parlamentar focada na Câmara dos Deputados. Sua proposta é aproximar cidadãos dos dados legislativos oficiais, convertendo informação dispersa em conhecimento acessível. O projeto se ancora na LAI e nos princípios de dados abertos, mas reconhece que a disponibilidade bruta não basta para garantir fiscalização social \cite{avelino2021democracia}. Ao combinar arquitetura de \textit{microservices}, ingestão híbrida (API v2 + arquivos em massa) e um front-end em Next.js 15/TypeScript, a plataforma busca reduzir barreiras técnicas e fomentar participação cidadã \cite{Gomes2010}.

A literatura de democracia digital evidencia que TICs ampliam possibilidades de participação, mas só geram valor quando articuladas a contextos de uso e inclusão. Avelino et al. mapeiam iniciativas de dados abertos e ouvidorias digitais, reforçando que tecnologias precisam ser mediadas por desenho institucional e pela criação de esferas públicas qualificadas \cite{avelino2021democracia}. Farias destaca que a internet desloca o cidadão de receptor para produtor de conteúdo, ampliando o espaço público virtual e a demanda por accountability contínua \cite{farias2013possibilidades}. Dados recentes da PNAD TIC 2024 mostram que a hiperconexão é majoritariamente móvel, mas ainda há lacunas de acesso, o que exige interfaces acessíveis e mobile-first \cite{pnad2024}. À luz desses estudos, o \textit{Tô De Olho} procura transformar a abertura de dados em participação concreta, aproximando a lógica deliberativa discutida por Gomes e Pateman da prática cotidiana de fiscalização e debate \cite{Gomes2010, pateman1970, gomes2019}.
...
Embora a API oficial da Câmara (\url{https://dadosabertos.camara.leg.br/api/v2/}) disponibilize dados públicos, eles permanecem dispersos, heterogêneos e tecnicamente onerosos para o cidadão leigo. A democracia digital exige não apenas acesso, mas condições de interpretação e participação qualificadas \cite{Gomes2010, pateman1970}. Sem interfaces acessíveis e contexto, a transparência corre o risco de se converter em pseudoparticipação, mantendo o distanciamento entre eleitores e representantes \cite{avelino2021democracia}. Com as eleições federais de 2026 no horizonte, torna-se urgente consolidar dados de deputados, despesas, votações e proposições em um ambiente \textit{web} usável, que permita fiscalização cidadã informada e inclusiva.
