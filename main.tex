...
\PassOptionsToPackage{alf}{abntex2cite}
...
\usepackage{enumitem} % Permite customizar listas (description, itemize, enumerate)
\begin{document}
...
% Nota: O arquivo resumo.tex já contém \clearpage
\input{src/sections/resumo}

% Abstract em Inglês (Obrigatório)
% Nota: O arquivo abstract.tex já contém \clearpage
\input{src/sections/abstract}

% Lista de Ilustrações (Opcional, mas recomendado)
\clearpage
\listoffigures


% Lista de Tabelas (Opcional, mas recomendado)
\clearpage
\listoftables
